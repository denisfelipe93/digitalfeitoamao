...
function toggleExpanded() {
  ...
  if (was && !expanded.value) {
    // graças ao scroll-padding-top global no html, o offset já está resolvido
...
<template>
  <!-- Section NORMAL: sem id interno; o id oficial vem do index.astro -->
  <section class="relative bg-white pt-8 sm:pt-10 md:pt-12">
